...
class _SubjectFormSheetState extends ConsumerState<SubjectFormSheet> {
  ...
  Future<void> _loadSubject() async {
    ...
    try {
      final subject =
          await ref.read(subjectRepositoryProvider).getById(widget.subjectId!);
      if (subject != null) {
  ...
  Future<void> _save() async {
    ...
    subject.facultyName = _facultyNameController.text.trim().isEmpty
        ? null
        : _facultyNameController.text.trim();
    subject.facultyEmail = _facultyEmailController.text.trim().isEmpty
        ? null
        : _facultyEmailController.text.trim();
    subject.facultyPhone = _facultyPhoneController.text.trim().isEmpty
        ? null
    ...
    subject.notes = _notesController.text.trim().isEmpty
        ? null
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: const BorderRadius.vertical(
              top: Radius.circular(24)), // radius2XL equivalent
        ),
...
Future<void> showSubjectFormSheet(BuildContext context, {int? subjectId}) {
  return showModalBottomSheet(
    ...
    useSafeArea: true,
    backgroundColor:
        Colors.transparent, // Required to show container border radius
